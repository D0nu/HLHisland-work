      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <div className='flex flex-wrap gap-6'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <span>Price</span>
              {formData.type === 'rent' && formData.city !== 'Lagos' && (
                  <span className='text-xs'>($ / month)</span>
                )}

              {formData.type === 'rent' && formData.city === 'Lagos' && (<span className='text-xs'>(N / month)</span>)}  
              </div>
            </div>
          </div>
        </div>
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <div className='flex gap-4'>
            ...
            type='button' 
            disabled={uploading}
            onClick={handleImageSubmit} className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80'>{uploading ? 'Uploading...' : 'Upload'}</button>
          </div>
          ...
          <button disabled={loading || uploading} className='bg-orange-700 text-black p-3 rounded-lg uppercase hover:opacity-95 disabled:opacity-80 font-semibold'>{loading ? 'Creating...' : 'Create Listing' }</button>
